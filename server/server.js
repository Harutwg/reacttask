...
app.use(express.static(path.join(__dirname, 'dist'))); // @TODO replace with your bundle folder

app.get('/', function(req, res) {
    res.sendFile(path.resolve('dist/index.html')); // @TODO replace with your index.html path
});
